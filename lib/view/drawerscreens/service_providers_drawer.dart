...
import 'package:zahra/view/screens/service_providers.dart';
import 'package:zahra/view/screens/splash_screen.dart';

class ServiceProvidersDrawer extends StatefulWidget {
  const ServiceProvidersDrawer({super.key});
  @override
  State<ServiceProvidersDrawer> createState() => _ServiceProvidersDrawerState();
}

class _ServiceProvidersDrawerState extends State<ServiceProvidersDrawer> {
  ...
  @override
  void initState() {
    selectedWidget = const ServiceProviders();
    super.initState();
  }
