...
import 'package:zahra/data/provider/drawer_provider.dart';
...
class _MainDrawerState extends State<MainDrawer> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<DrawerProvider>().setWidget(const HomeScreen());
    });
  }
  ...
  Widget zahraTextButton(
    ...
    return TextButton.icon(
      ...
      onPressed: () {
        setState(() {
          context.read<DrawerProvider>().setWidget(gotoWidget);
                      ...
                      child: Column(
                        ...
                        children: [
                          zahraTextButton(
                            'خدمات طبية',
                            ismedical(
                              context.watch<DrawerProvider>().selectedWidget!,
                            )
                                ? FontWeight.w700
                                : FontWeight.w400,
                            ismedical(context
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: context.watch<DrawerProvider>().selectedWidget!,
                ),
              ],
            ),
          ),
